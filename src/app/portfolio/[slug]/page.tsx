...
export default function MuralDetailPage() {
  ...
  const mural = getMuralBySlug(slug);
        ...
        <main className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              The mural you&apos;re looking for doesn&apos;t exist.
            </p>
  ...
  // Get related murals (same category, excluding current)
  const relatedMurals = murals
    .filter((m) => m.category === mural.category && m.id !== mural.id)
    .slice(0, 3);
